...
$aLang = array(
    ...
    'KHVT_ATM_THEME_MISSING_THUMBNAIL'                             => 'Die Information thumbnail in der adminTheme.php wurde nicht gepflegt.' //
        .'<br>Speichern Sie ein Thumbnailbild mit den Seitenverhältnis 1265x468 in das Verzeichnis unter /source/out/{themeId}/{bildname}.{endung} (bspw. /source/out/admin/thumbnail.png).'.'<br>Tragen Sie den Namen in die Variable der /source/Application/views/{themeid}/adminTheme.php mit dem Index  \'thumbnail\' ein.
<br>Beispiel:
<pre>
$themeParameter = [
    \'thumbnail\'   => \'theme.jpg\',
